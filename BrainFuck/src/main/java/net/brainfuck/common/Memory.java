...
public class Memory {
     ...
     * @throws MemoryOverFlowException if the value overflow or underflow the cell capacity
     */
     ...
     *
     * @return the current memory
     * @throws MemoryOverFlowException if the value exceed the max capacity of the cell
     */
     ...
     *
     * @return the current memory
     * @throws MemoryOverFlowException if the value exceed the minimum capacity of the cell
     */
     ...
     *
     * @param returnValue if there is a return value
     * @return the memory
     * @throws MemoryOutOfBoundsException the memory out of bounds exception
     */
