...
public class Executer {
	 ...
	 */
	public void execute(AbstractInstruction instruction) throws MemoryOutOfBoundsException, BracketsParseException,
			MemoryOverFlowException, FileNotFoundIn, IOException {
		for (ContextExecuter contextExecuter : contextExecuters) {
			contextExecuter.execute(instruction, argumentExecuter);
